...
export const Submit: React.FC = () => {
    ...
    function onSubmitClick() {
        ...
        if (validationRateRevisionData?.grossBrValid === " " && validationRateRevisionData?.mspFeePercentageValid === " " &&
            validationRateRevisionData?.mspFeeValid === " " && validationRateRevisionData?.netBillRateValid === " " &&
            validationRateRevisionData?.payRateValid === " " && validationRateRevisionData?.refFeeValid === " " &&
            validationRateRevisionData?.taxOHPercentageValid === " " && validationRateRevisionData?.optedForHBValid === " " &&
            validationRateRevisionData?.taxOHValid === " " && validationRateRevisionData?.healthBValid === " " &&
            validationRateRevisionData?.netPurchaseValid === " " && validationRateRevisionData?.marginValid === " "
            && validationRateRevisionData?.rateRevisionReasonValid
        ) {
            dispatch(sendAllData(candidateDataToSend, clientDataToSend, vendorDataToSent,
                // referralDataToSend,
                jobDataToSend,
